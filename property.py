...
train_arguments.load_graphs_path = f"tests/data/{propName}_train_graphs.bin"
...
# train_arguments.pretrained_model = f"tests/explicit_H_{name}/{name}.pkl"
...
# train_arguments.is_shuffle = True
# train_arguments.is_atom_position = True
# train_arguments.NN = "ReadoutNN"
# train_arguments.NN = "Set2SetNN"
...
test_arguments.load_graphs_path = f"tests/data/{propName}_test_graphs.bin"
